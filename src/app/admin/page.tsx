                ...
                <Modal open={isModalOpen} onSubmit={handlesubmit} onClose={() => setIsModalOpen(false)}>
                    {editId &&
                        <div className="flex flex-col items-center justify-center gap-[20px]">
                            <h2 className="text-[1.8rem] text-[var(--text-color)] font-[570] my-[2rem]">Edit Item</h2>
                            <input 
                                type="text"
                                name="name"
                                value={form.name}
                                ...
                                className="px-[1rem] py-[0.6rem] border border-[var(--brand-color)] bg-[var(--table-bg-color)] rounded-[12px] text-[var(--text-color)] focus:border-2"
                            />
                            <input 
                                type="number"
                                name="price"
